    ...
    <div class="row">
      <div class="col-md-4">
        ...
        <form method="post" action="<?php $_PHP_SELF ?>">
          ...
          <hr />
          <p>Mulighed for genbrug af kode </p>
          ...
          <hr />
          <p>Mulighed for brug af byggeklodser</p>
          ...
          <hr />
          <p>Vurdering af kompleksiteten. 10 er en lav kompleksitet.</p>
          ...
          <br /><br /><br /><br />
          <p>Vægtet score: <b><span id="UdrUdv"></span></b>
            <hr />
      ...
      <div class="col-md-4">
        ...
        <br />
        <p>Systemer der bliver interageret med</p>
        ...
        <br />
        <p>Kvalitet af nuværende dokumentation af processen(PDD o.lign)</p>
        ...
        <br />
        <p>Forbedring af Kunde-tilfredshed.</p>
        ...
        <br /><br />
        <br /><br />Vægtet score: <b> <span id="UdrPro"></span></b>
        <hr />
      ...
      <div class="col-md-4">
        ...
        <br />
        <p>Besparelser målt i antallet af FTEer. 10 er en høj besparelse.</p>
        ...
        <hr />
        <p>Overensstemmelse med samlet vision </p>
        ...
        Vægtet score: <b> <span id="UdrLev"></span></b>
        <hr />
